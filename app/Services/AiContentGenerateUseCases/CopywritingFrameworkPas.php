...
class CopywritingFrameworkPas implements AiContentGenerateUseCaseContract
{

    public static function getUniqueIdentifier(): string
    {
        return 'copywriting_framework_pas';
    }
    ...
    {
        return [
            'prompt' => 'Generate a marketing copy in PAS format in :language_id language using a :tone_id tone. Description : :description',
        ];
    }
    ...
    {
        return ['id' => self::getUniqueIdentifier(), 'name' => __('Copywriting Framework PAS')];
    }
