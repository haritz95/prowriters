...
return [
    ...
    'providers' => [
        ...
        App\Providers\EnforceMorphMapProvider::class,
        App\Providers\MomentumModalServiceProvider::class,
    ],
    ...
    'aliases' => [
        ...
        'Form'         => App\Services\Form\FormFacade::class,
